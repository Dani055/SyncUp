...
fun LoginScreen(
    ...
    Column(
        ...
        Column(
            modifier = Modifier.padding(start = 50.dp, end = 50.dp, bottom = 24.dp),
            ...
            OutlinedTextField(colors = TextFieldDefaults.outlinedTextFieldColors(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 15.dp),
                label = { Text(color = MaterialTheme.colorScheme.primary, text = "Email") },
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 5.dp),
                label = { Text(color = MaterialTheme.colorScheme.primary, text = "Password") },
            ...
            //Row for the remember me checkbox and forgot password
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Checkbox(
                        ...
                        onCheckedChange = { loginViewModel.changeRememberMe() })
                    ClickableText(style = TextStyle(
                        fontSize = 13.sp,
                        color = MaterialTheme.colorScheme.primary
                    ), text = AnnotatedString(
                        "Remember me"
                    ), onClick = { loginViewModel.changeRememberMe() })
                }
                Text(
                    fontSize = 13.sp,
                    color = MaterialTheme.colorScheme.primary,
